...
PEMulSampleScene * PEMulSampleScene::createWithSize(string name, int width, int height)
{
	PEMulSampleScene *scene = new PEMulSampleScene();
...
bool PEMulSampleScene::initWithSize(string name, int width, int height)
{
	if(!PENode::init()){
		return false;
	}
	...
	m_event->setPressEndFunction(std::bind(&PEMulSampleScene::saveViewToPicture, this));
...
int PEMulSampleScene::Width()
{
	return m_width;
}

int PEMulSampleScene::Height()
{
	return m_height;
}

void PEMulSampleScene::setFrameBuffer()
{
...
void PEMulSampleScene::setGLPrograms(){
...
void PEMulSampleScene::saveViewToPicture(){
...
void PEMulSampleScene::displayHardwareInfo()
{
