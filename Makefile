...
LINK = -lglfw3 -lGL -lGLU -lX11 -lXxf86vm -lXrandr -lpthread -lXi -lm -lrt \
	   -luuid -lc -ldl -lpng -ljpeg -lXcursor -lXinerama -lfreetype
BPath = Base/
MPath = Math/
SPath = Render/
...
ALL:main
main:main.o PEScene.o TestScene.o NormalMapScene.o JuliaScene.o PETexture.o PETextureManager.o PEKeyboardManager.o PEMulSampleScene.o $(BASE) $(MATH) $(SHADER)
	$(CC) -o main $(MATH) $(BASE) $(SHADER) main.o PEScene.o TestScene.o \
		NormalMapScene.o JuliaScene.o PETexture.o PETextureManager.o \
	   	PEKeyboardManager.o PEMulSampleScene.o $(LINK) -g
main.o:main.cpp PEEngine.h PEMacro.h
	$(CC) -c main.cpp
PEMulSampleScene.o:PEMulSampleScene.cpp PEMulSampleScene.h
	$(CC) -c PEMulSampleScene.cpp $(DGL) -g
